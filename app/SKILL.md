...
2. Once the user submits the form (which appears in the format `[Form Submit] /action submit_org_details {"org_name": "...", "org_description": "...", "org_email": "...", "org_phone": "...", "user_position": "..."}`), you MUST parse the JSON payload and immediately call the `save_org_details` tool with these arguments. Do not call the `show_org_details_form` tool again after receiving this submission. Do not print any conversational log messages like "Saving organization details" in chat.
